...
pygame.display.set_caption("Career Cellular Automaton")
...
while running:
    ...
    surface_array[grid == 1] = [120, 200, 255]
    surface_array[grid == 2] = [100, 160, 240]
    surface_array[grid == 3] = [80, 120, 220]
    surface_array[grid == 4] = [60, 90, 190]
    surface_array[grid == 5] = [40, 60, 160]
    surface_array[grid == 6] = [25, 35, 120]
    ...
    pygame.display.set_caption(
        f"Career CA - Gen: {generation} {'[PAUSED]' if paused else ''}"
    )
    pygame.display.flip()
    clock.tick(FPS)
