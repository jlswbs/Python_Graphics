...
pygame.display.set_caption("Seeds Cellular Automaton")
...
while running:
    ...
    surface_array[grid == 1] = [255, 120, 40]
    surface_array[grid == 0] = [5, 5, 10]
    ...
    pygame.display.set_caption(
        f"Seeds CA - Gen: {generation} {'[PAUSED]' if paused else ''}"
    )
