...
pygame.display.set_caption("Banners Cellular Automaton")
...
while running:
    ...
    surface_array[grid == 1] = [255, 255, 120]
    surface_array[grid == 2] = [255, 140, 80]
    surface_array[grid == 3] = [220, 60, 120]
    surface_array[grid == 4] = [80, 20, 100]
    ...
    pygame.display.set_caption(
        f"Banners CA - Gen: {generation} {'[PAUSED]' if paused else ''}"
    )
