...
pygame.display.set_caption("Cooties Cellular Automaton")
...
while running:
    ...
    surface_array[grid == 1] = [255, 100, 220]
    surface_array[grid == 2] = [240, 60, 200]
    surface_array[grid == 3] = [200, 40, 170]
    surface_array[grid == 4] = [160, 30, 140]
    surface_array[grid == 5] = [120, 20, 110]
    surface_array[grid == 6] = [80, 15, 80]
    surface_array[grid == 7] = [50, 10, 50]
    ...
    pygame.display.set_caption(f"Cooties CA - Gen: {generation} {'[PAUSED]' if paused else ''}")
    pygame.display.flip()
    clock.tick(FPS)
