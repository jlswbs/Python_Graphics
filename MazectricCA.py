...
pygame.display.set_caption("Mazectric Cellular Automaton")
...
while running:
    ...
    surface_array[grid == 1] = [0, 255, 180]
    ...
    pygame.display.set_caption(
        f"Mazectric CA - Gen: {generation} {'[PAUSED]' if paused else ''}"
    )
