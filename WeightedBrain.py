# Weighted Brain Cellular Automaton
...
pygame.display.set_caption("Weighted Brain Cellular Automaton")
...
while running:
    ...
    surface_array[grid == 1] = [200, 120, 255]
    surface_array[grid == 2] = [160, 80, 220]
    surface_array[grid == 3] = [120, 50, 180]
    surface_array[grid == 4] = [80, 30, 140]
    surface_array[grid == 5] = [40, 15, 80]
    ...
    pygame.display.set_caption(f"Weighted Brain CA - Gen: {generation} {'[PAUSED]' if paused else ''}")
    pygame.display.flip()
    clock.tick(FPS)
