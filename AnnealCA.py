...
pygame.display.set_caption("Anneal Cellular Automaton")
...
while running:
    ...
    surface_array[grid == 1] = [255, 240, 180]
    surface_array[grid == 0] = [15, 15, 20]
    ...
    pygame.display.set_caption(
        f"Anneal CA - Gen: {generation} {'[PAUSED]' if paused else ''}"
    )
