...
pygame.display.set_caption("Crystal Cellular Automaton")
...
while running:
    ...
    if not paused:
        ...
        birth = (grid == 0) & ((neighbors == 3) | (neighbors == 4))
        new_grid[birth] = 1
    ...
    surface_array[grid == 1] = [200, 255, 255]
    surface_array[grid == 2] = [160, 240, 255]
    surface_array[grid == 3] = [120, 210, 255]
    surface_array[grid == 4] = [90, 180, 240]
    surface_array[grid == 5] = [70, 150, 220]
    surface_array[grid == 6] = [50, 120, 200]
    surface_array[grid == 7] = [30, 90, 180]
    surface_array[grid == 8] = [20, 60, 140]
    ...
    pygame.display.set_caption(
        f"Crystal CA - Gen: {generation} {'[PAUSED]' if paused else ''}"
    )
    pygame.display.flip()
    clock.tick(FPS)
