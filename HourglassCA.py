...
pygame.display.set_caption("HGlass Cellular Automaton")
...
while running:
    ...
    surface_array[grid == 1] = [120, 240, 255]
    surface_array[grid == 2] = [90, 200, 240]
    surface_array[grid == 3] = [60, 160, 220]
    surface_array[grid == 4] = [40, 120, 190]
    surface_array[grid == 5] = [20, 70, 140]
    ...
    pygame.display.set_caption(f"HGlass CA - Gen: {generation} {'[PAUSED]' if paused else ''}")
    pygame.display.flip()
    clock.tick(FPS)
