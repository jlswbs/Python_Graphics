...
pygame.display.set_caption("Meteor Cellular Automaton")
...
while running:
    ...
    surface_array[grid == 2] = [255, 160, 50]
    surface_array[grid == 3] = [200, 80, 20]
    surface_array[grid == 4] = [120, 40, 10]
    surface_array[grid == 5] = [60, 20, 5]
    ...
    pygame.display.set_caption(f"Meteor CA - Gen: {generation} {'[PAUSED]' if paused else ''}")
    pygame.display.flip()
    clock.tick(FPS)
