...
pygame.display.set_caption("Brian 6 Cellular Automaton")
...
while running:
    ...
    surface_array[grid == 1] = [100, 240, 255]
    surface_array[grid == 2] = [80, 160, 255]
    surface_array[grid == 3] = [60, 100, 220]
    surface_array[grid == 4] = [40, 60, 180]
    ...
    pygame.display.set_caption(f"Brian 6 CA - Gen: {generation} {'[PAUSED]' if paused else ''}")
    pygame.display.flip()
    clock.tick(FPS)
