...
pygame.display.set_caption("Amoeba Cellular Automaton")
...
while running:
    ...
    surface_array[grid == 1] = [180, 255, 140]
    surface_array[grid == 2] = [140, 220, 100]
    surface_array[grid == 3] = [100, 180, 70]
    surface_array[grid == 4] = [80, 140, 50]
    surface_array[grid == 5] = [60, 110, 40]
    surface_array[grid == 6] = [40, 80, 30]
    surface_array[grid == 7] = [25, 50, 20]
    ...
    pygame.display.set_caption(
        f"Amoeba CA - Gen: {generation} {'[PAUSED]' if paused else ''}"
    )
    pygame.display.flip()
    clock.tick(FPS)
