...
pygame.display.set_caption("2x2 Cellular Automaton")
...
while running:
    ...
    surface_array[grid == 1] = [255, 180, 80]
    ...
    pygame.display.set_caption(
        f"2x2 CA - Gen: {generation} {'[PAUSED]' if paused else ''}"
    )
