...
pygame.display.set_caption("Midges Cellular Automaton")
...
while running:
    ...
    surface_array[grid == 1] = [220, 255, 140]
    surface_array[grid == 2] = [180, 240, 100]
    surface_array[grid == 3] = [40, 200, 70]
    surface_array[grid == 4] = [0, 160, 50]
    surface_array[grid == 5] = [70, 120, 40]
    surface_array[grid == 6] = [40, 80, 25]
    ...
    pygame.display.set_caption(f"Midges CA - Gen: {generation} {'[PAUSED]' if paused else ''}")
    pygame.display.flip()
    clock.tick(FPS)
