...
pygame.display.set_caption("Pulsar Cellular Automaton")
...
while running:
    ...
    if not paused:
        ...
        birth = (grid == 0) & ((neighbors == 3) | (neighbors == 4) | (neighbors == 5))
        new_grid[birth] = 1

        survive = (grid == 1) & ((neighbors == 2) | (neighbors == 3) | (neighbors == 4))
        new_grid[survive] = 1
    ...
    surface_array[grid == 1] = [255, 80, 255]
    surface_array[grid == 2] = [220, 60, 240]
    surface_array[grid == 3] = [180, 40, 220]
    surface_array[grid == 4] = [140, 30, 200]
    surface_array[grid == 5] = [100, 40, 180]
    surface_array[grid == 6] = [70, 50, 160]
    surface_array[grid == 7] = [50, 70, 140]
    surface_array[grid == 8] = [30, 90, 120]
    ...
    pygame.display.set_caption(
        f"Pulsar CA - Gen: {generation} {'[PAUSED]' if paused else ''}"
    )
    pygame.display.flip()
    clock.tick(FPS)
