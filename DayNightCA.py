...
pygame.display.set_caption("Day & Night Cellular Automaton")
...
while running:
    ...
    surface_array[grid == 1] = [180, 220, 255]
    surface_array[grid == 0] = [8, 10, 20]
    ...
    pygame.display.set_caption(
        f"Day & Night CA - Gen: {generation} {'[PAUSED]' if paused else ''}"
    )
