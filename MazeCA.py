...
pygame.display.set_caption("Maze Cellular Automaton")
...
while running:
    ...
    surface_array[grid == 1] = [255, 220, 80]
    surface_array[grid == 0] = [5, 8, 15]
    ...
    pygame.display.set_caption(
        f"Maze CA - Gen: {generation} {'[PAUSED]' if paused else ''}"
    )
