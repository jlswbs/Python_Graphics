...
pygame.display.set_caption("Morley Cellular Automaton")
...
while running:
    ...
    surface_array[grid == 1] = [120, 255, 180]
    ...
    pygame.display.set_caption(
        f"Morley CA - Gen: {generation} {'[PAUSED]' if paused else ''}"
    )
