...
pygame.display.set_caption("Venus Cellular Automaton")
...
while running:
    ...
    surface_array[grid == 1] = [200, 255, 180]
    surface_array[grid == 2] = [180, 220, 140]
    surface_array[grid == 3] = [140, 180, 120]
    surface_array[grid == 4] = [120, 100, 160]
    surface_array[grid == 5] = [100, 60, 140]
    surface_array[grid == 6] = [70, 30, 100]
    ...
    pygame.display.set_caption(
        f"Venus CA - Gen: {generation} {'[PAUSED]' if paused else ''}"
    )
    pygame.display.flip()
    clock.tick(FPS)
