...
pygame.display.set_caption("Swirl Cellular Automaton")
...
while running:
    ...
    surface_array[grid == 1] = [200, 160, 255]
    surface_array[grid == 2] = [160, 120, 240]
    surface_array[grid == 3] = [130, 80, 220]
    surface_array[grid == 4] = [100, 50, 190]
    surface_array[grid == 5] = [70, 30, 160]
    surface_array[grid == 6] = [50, 20, 120]
    surface_array[grid == 7] = [30, 10, 80]
    ...
    pygame.display.set_caption(
        f"Swirl CA - Gen: {generation} {'[PAUSED]' if paused else ''}"
    )
    pygame.display.flip()
    clock.tick(FPS)
