...
pygame.display.set_caption("Rings Cellular Automaton")
...
while running:
    ...
    surface_array[grid == 1] = [80, 255, 255]
    surface_array[grid == 2] = [60, 220, 240]
    surface_array[grid == 3] = [40, 180, 220]
    surface_array[grid == 4] = [30, 140, 200]
    surface_array[grid == 5] = [40, 100, 180]
    surface_array[grid == 6] = [50, 60, 160]
    surface_array[grid == 7] = [40, 30, 120]
    ...
    pygame.display.set_caption(
        f"Rings CA - Gen: {generation} {'[PAUSED]' if paused else ''}"
    )
    pygame.display.flip()
    clock.tick(FPS)
